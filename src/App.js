...
function App() {
    ...
    return (
        <div className="App">
            {!properties && <SearchContainer searchValue={searchValue} setSearchValue={setSearchValue}
                                             searchForProperties={searchForProperties}/>}
            {properties &&
            <React.Fragment><SearchAppBar/><PropertyPreviewList properties={properties}/></React.Fragment>}
        </div>
    );
}
